	...
	<body>
		...
		<div id="navbar">
			<nav class="navbar navbar-expand-md navbar-light">
				<a class="navbar-brand" href="ClienteLogin.php"><img src="../img/logo.jpg" id="logo_img"></a>
				...
				<div class="collapse navbar-collapse" id="links">
					<ul class="navbar-nav">
						<li><a class="nav-link" href="ClienteLogin.php">Volver a inicio</a></li>
					</ul>
        ...
        <hr/>
		<footer>
			<p style="text-align: center">Diseño y desarrollo</p>
        </footer>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
                        <p style="color: black;">Recuerde que sus datos serán totalmente borrados de nuestros servidores.</p>
                    </div>
